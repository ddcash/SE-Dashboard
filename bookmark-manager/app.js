...
function openGroupModal(groupId) {
    ...
    <div class="modal-body">
      <form id="group-form" onsubmit="submitGroup(event, this.dataset.groupId)" data-group-id="${esc(groupId || '')}">
        <div class="form-row">
...
function openCardModal(catId, bmId) {
  ...
  openModal(`
    ...
    <div class="modal-body">
      <form id="card-form" onsubmit="submitCard(event, this.dataset.catId, this.dataset.bmId)" data-cat-id="${esc(catId)}" data-bm-id="${esc(bmId || '')}">
        <div class="form-row">
        ...
        <div class="modal-footer">
          ...
          ${bm ? `<button type="button" class="btn ${bmHidden ? 'btn--primary' : 'btn--ghost'}"
            data-bmid="${esc(bmId)}" onclick="window[this.dataset.action + 'Item']('bookmarks', this.dataset.bmid);closeModal()" data-action="${bmHidden ? 'unhide' : 'hide'}">
...
function openCategoryModal(catId) {
  ...
  openModal(`
    ...
    <div class="modal-body">
      <form id="cat-form" onsubmit="submitCategory(event, this.dataset.catId)" data-cat-id="${esc(catId || '')}">
        <div class="form-row">
        ...
        <div class="modal-footer">
          ${cat ? `<button type="button" class="btn ${catHidden ? 'btn--primary' : 'btn--ghost'}"
            data-cat-id="${esc(catId)}" onclick="window[this.dataset.action + 'Item']('categories', this.dataset.catId);closeModal()" data-action="${catHidden ? 'unhide' : 'hide'}">
...
function updatePalette(q) {
  ...
  const cmdsHtml = matchCmds.map((c, i) => `
    <div class="palette-item" onclick="window._palActions[this.dataset.index]()" data-index="${i}">
